...
int  IsLeapYear(int year) // ïðîâíðêà âèñîêîñíîãî ãîäà
{
    return (((year % 4 == 0) &&
             (year % 100 != 0)) ||
            (year % 400 == 0));
...
int main()
{
    ...
    //ñ÷èòûâàíèå è ïðîâåðêà äàòû è ôàéëà
    while (true){
        year="";
        day="";
        month="";
    ...
    int cl1, cl2;
    double cl3=0,cl4=0,cl5=0,pcl5=0,pcl3=0,ppcl3=0,ppcl5=0;
    Point p1,p2,p3;
    p1.x=-1;
    p1.y=0;
    p2.x=-1;
    ...
    if (in.is_open()){
        while (getline(in, line)){
                ...
                if (start && !sfound){
                    ...
                    //âû÷èñëåíèå òî÷åê äëÿ íàõîæäåèÿ ïèêà
                    if (p1.x != cl3 && !found1){
                        p1.x=cl3;
                        p1.y=cl5;
                        found1=true;
